...
Summary: Human-readable proof is not enough when repository automation enforces a schema. A sanitized agent-operations lesson on making behavior evidence readable to both reviewers and policy parsers.
