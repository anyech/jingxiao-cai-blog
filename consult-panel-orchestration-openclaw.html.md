...
## What the Current Panel Actually Looks Like
 ...
 Rotating wildcard endpoint
 Rotating wildcard panelist
 rotating_wildcard
...
## Why Timeout Policy Had To Change
 ...
 1.0
 150s
 Default decision anchor. Keep the leash longest.
 ...
 1.0
 150s
 Full interpretive weight if present, but do not block forever.
 ...
 0.75
 120s
 Useful corroboration or dissent, but non-core.
 ...
 0.4
 90s
 Exploratory only. Drop aggressively when it becomes tail latency.
